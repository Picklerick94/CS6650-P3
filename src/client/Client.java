	...
	try {
		for (int i = 0 ; i < hl.serverPorts.length ; i++)
	     ...
	     stubs[i] = (ServerInterface) registries[i].lookup("compute.ServerInterface");  
			...
			hl.log(stubs[0].KeyValue(UUID.randomUUID(), "PUT", "q1", "1"));
		    hl.log(stubs[1].KeyValue(UUID.randomUUID(), "PUT", "q2", "2"));
		    hl.log(stubs[2].KeyValue(UUID.randomUUID(), "PUT", "q3", "3"));
		    hl.log(stubs[3].KeyValue(UUID.randomUUID(), "PUT", "q4", "4"));
		    hl.log(stubs[4].KeyValue(UUID.randomUUID(), "PUT", "q5", "5"));
		  
		    hl.log(stubs[0].KeyValue(UUID.randomUUID(), "GET", "q1", ""));
		    hl.log(stubs[1].KeyValue(UUID.randomUUID(), "GET", "q2", ""));
		    hl.log(stubs[2].KeyValue(UUID.randomUUID(), "GET", "q3", ""));
		    hl.log(stubs[3].KeyValue(UUID.randomUUID(), "GET", "q4", ""));
		    hl.log(stubs[4].KeyValue(UUID.randomUUID(), "GET", "q5", ""));
		  
		    
		    hl.log(stubs[0].KeyValue(UUID.randomUUID(), "DEL", "q1", ""));
		    hl.log(stubs[4].KeyValue(UUID.randomUUID(), "DEL", "q2", ""));
		    hl.log(stubs[3].KeyValue(UUID.randomUUID(), "DEL", "q3", ""));
		    hl.log(stubs[3].KeyValue(UUID.randomUUID(), "DEL", "q4", ""));
		    hl.log(stubs[4].KeyValue(UUID.randomUUID(), "DEL", "q5", ""));
